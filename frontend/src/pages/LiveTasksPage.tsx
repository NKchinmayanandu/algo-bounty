...
export default function LiveTasksPage() {
  ...
  const statuses = ['ALL', 'OPEN', 'FUNDED', 'CLAIMED', 'SUBMITTED', 'VERIFIED', 'PAID'];
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-3xl font-bold text-text-primary mb-2">Live Tasks</h1>
        <p className="text-text-secondary">Browse available bounties and start earning</p>
      </motion.div>
              ...
              <Card onClick={() => handleTaskClick(task.id)} className="h-full">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border-subtle">
                  <div className="flex items-center gap-1.5 text-sakura-400">
                    <Coins size={14} />
                    <span className="text-sm font-semibold">{task.reward} ALGO</span>
                  </div>
